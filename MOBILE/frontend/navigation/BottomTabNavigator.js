...
import LearnStack from "../navigation/learnNav";
...
const BottomTabNavigator = () => {
  return (
    ...
    >
      <Tab.Screen
        name="Learn"
        component={LearnStack} // Now using LearnStack instead of UnitStack
        options={({ route }) => {
          const routeName =
          ...
          const hideTabBarScreens = [
            "Lessons",
            "LessonDetail",
            "DailyChallenge", // Hide tab bar in Daily Challenge
          ];
